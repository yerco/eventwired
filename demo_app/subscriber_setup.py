...
from demo_app.subscribers.error_subscribers import handle_403_event, handle_404_event, handle_405_event, \
...
async def register_subscribers(event_bus):
    ...
    event_bus.subscribe('websocket.connection.closed', websocket_connection_close)
