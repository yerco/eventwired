...
async def test_add_book_success(event_add_book):
    ...
    # Call the controller
    await commands_books_controller(event_add_book, form_service=form_service_mock, template_service=template_service_mock,
...
async def test_update_book_success(event_update_book):
    ...
    # Call the controller
    await commands_books_controller(event_update_book, form_service=form_service_mock, template_service=template_service_mock,
                                    orm_service=orm_service_mock, redis_service=redis_service_mock)
...
async def test_delete_book_success(event_delete_book):
    ...
    with patch("demo_app.controllers.commands_books_controller.HTTPController") as MockHTTPController:
        ...
        # Call the controller
        await commands_books_controller(event_delete_book, form_service=form_service_mock, template_service=template_service_mock,
                                        orm_service=orm_service_mock, redis_service=redis_service_mock)
...
async def test_delete_book_method_not_allowed(event_delete_book_wrong_method):
    ...
    with patch("demo_app.controllers.commands_books_controller.HTTPController") as MockHTTPController:
        ...
        # Call the controller
        await commands_books_controller(event_delete_book_wrong_method, form_service=form_service_mock, template_service=template_service_mock,
                                        orm_service=orm_service_mock, redis_service=redis_service_mock)
